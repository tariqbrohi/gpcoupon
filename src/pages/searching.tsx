  ...
  return (
    <div className={classes.searchingcontainer}>
      ...
      <div className={classes.searchMiniBnnerWrapper}>
        <div
          style={{
            backgroundImage: `linear-gradient(0deg, rgba(0,0,0,.45), rgba(0,0,0,.45)), url(/asset/categories_kr.png) `,
          }}
          className={classes.searchMiniBanner}
        >
          <Typography className={classes.searchMiniBannerText} variant="h6">
            Category
          </Typography>
        </div>
        <div
          style={{
            backgroundImage: `linear-gradient(0deg, rgba(0,0,0,.45), rgba(0,0,0,.45)), url(/asset/brands_kr.png)`,
          }}
          className={classes.searchMiniBanner}
        >
          <Typography className={classes.searchMiniBannerText} variant="h6">
      ...
      <div className={classes.SuggestionWrapper}>
        <Typography variant="h5" className={classes.SuggestionTitle}>
          Suggested searches
        </Typography>
        <div className={classes.SuggestionChipWrapper}>
      ...
      <div className={classes.recentSearchWrapper}>
        <Typography variant="h5" className={classes.recentSearchTitle}>
          Recent Searches
        </Typography>
